...
//		this.boxListCache = boxList;
	...
	protected int drawLine(Graphics g, List<BrailleInfo> brailleList, int start, Rectangle bound, List<BrailleBox> boxList, boolean drawExtra)
	{
	...
	protected int drawTable(Graphics g, List<BrailleInfo> brailleList, List<BrailleBox> boxList, int start, Rectangle tableBound, boolean drawExtra)
	{
		// 各行の高さ、各列の幅を計算する
	...
	protected int drawTableLayouted(Graphics g, List<BrailleInfo> brailleList, List<BrailleBox> boxList, int start, Rectangle tableBound, boolean drawExtra)
	{
		start++;
